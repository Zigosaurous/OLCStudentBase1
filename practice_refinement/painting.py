...
# print("Welcome to ColorBest Painting Services!")
# apartment = input("Select apartment type (A)3-room, (B)4-room, (C)5-room:").upper()
# if apartment == "A":
#     no_rooms = 3
# elif apartment == "B":
#     no_rooms = 4
...
# paint_type = input("Select paint package (A)Easy-clean, (B)Mould-free, (C)Premier all in one:").upper()
...
#         check = int(input("Please repeat the colour code again"))

#         if paint_colour != check:
#             print("Invalid colour code entry. Please try again")
#         elif paint_colour > 0 and paint_colour < 59:
#             colour_type += [paint_colour]
#             break
#         else:
#             print("Invalid colour code entry. Please try again")
...
cost_of_rooms = no_rooms*120
total_cost = cost_of_rooms + base_cost
print(f"Total cost of package is ${total_cost}")
