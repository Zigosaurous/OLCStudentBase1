...
for students in star_students:
    print("Congratulations ", students + "!", "With an attendance of ", str(attendance[students]) + "%", "and a score of ", str(scores[students]), ", you are awarded with the Star Student Award!" )