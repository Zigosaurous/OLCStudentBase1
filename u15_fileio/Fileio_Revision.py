...
# with open("filename.txt", "a") as fobj:
...
#   .write()
#   .read() --- reads content of the file, store it into a string
#   .readline() --- reads only 1 time
#   .readlnes() --- reads content of file, store each line as a item in a list
#   .writelines() --- function parameter is a list. output each item in list to file

# with open("example.txt", "w") as any_name_of_file:
#     #write spmething
#     any_name_of_file.write("Hi")

##### IMPORTANT!!!!!! is file exist, it will overwrite, if file mot exist, it will create

# with open("example.txt", "w") as any_name_of_file:
#     #write spmething
#     content = any_name_of_file.read() #reads content of the file, store it is a string
...
# with open("q3_diary.txt", "a") as diary:
#     diary.write("\nI also revised Python at night.")
#     # content = diary.read()

# with open("q3_diary.txt", "r") as diary:
#     content = diary.read()
...
# with open("q4_fruits.txt", "r") as fruits:
...
# with open("q5_marks.txt", "r") as marks:
#     content = marks.readlines()
...
# # content = ["75","62",88,23,564,32,1684,321]

# print(max(content))
# # for line in content: # looping through the list.
# #     print(line)
# print(min(content))
...
# print(f"The number of people is {count}")
