...
#     else:
#         num_days = input_date[:2]
#         num_days = int(num_days)

#         num_months = input_date[3:]
#         num_months = int(num_months)

#     total_days = (num_days - 1) + ((num_months - 1) * 30)
#     return total_days

# input_date = input("Please enter a date in (DD-MM) format: ")

# print(calculate_days(input_date))
